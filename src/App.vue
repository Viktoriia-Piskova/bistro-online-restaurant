<template>
  <header>
    <nav class="desktop-menu">
      ...
      <ul class="user">
        ...
        <li class="cart-link" @add_to_cart="addToCart">
          <router-link to="/cart"
            ><svg
              ...
              x="0px"
              y="0px"
              viewBox="0 0 53.524 53.524"
              style="enable-background: new 0 0 53.524 53.524"
              xml:space="preserve"
            >
              <g>
                <path
                  fill="#fff"
                  d="M53.262,22.489c0.03-0.16,0.03-0.33,0.01-0.55c-0.04-0.43-0.29-0.87-0.75-0.95c-3.76-0.71-7.61-0.56-11.48-0.26
		...
		c0-0.02-0.01-0.03-0.01-0.06c1.55-0.08,3.09-0.16,4.64-0.27C47.372,32.129,43.531,40.559,43.131,40.619z"
            ...
            {{ $store.state.cardQuantity }}</router-link
          >
        </li>
      </ul>
    </nav>
    ...
    <div class="mobile-menu">
      ...
      <div class="cart-link-mobile" @add_to_cart="addToCart">
        <router-link to="/cart"
          ><svg
            class="cart-icon"
            version="1.1"
